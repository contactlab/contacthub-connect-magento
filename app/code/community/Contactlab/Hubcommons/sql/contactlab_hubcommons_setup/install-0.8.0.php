...
$taskTable = $installer->getConnection()
        ->newTable($installer->getTable("contactlab_hubcommons/task"))
        ...
        ->addIndex($installer->getIdxName('contactlab_hubcommons/task', array('status')),
            array('status'))
        ->setComment("Tasks");
...
$installer->run("drop table if exists {$installer->getTable("contactlab_hubcommons/task_event")};");
$taskEventTable = $installer->getConnection()
        ->newTable($installer->getTable("contactlab_hubcommons/task_event"))
        ...
        ->addForeignKey($installer->getFkName('contactlab_hubcommons/task_event', 'task_id', 'contactlab_hubcommons/task', 'task_id'),
            'task_id', $installer->getTable('contactlab_hubcommons/task'), 'task_id',
            Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey($installer->getFkName('contactlab_hubcommons/task_event', 'user_id', 'admin/user', 'user_id'),
...
$installer->run("drop table if exists {$installer->getTable("contactlab_hubcommons/log")};");
$logTable = $installer->getConnection()
        ->newTable($installer->getTable("contactlab_hubcommons/log"))
...
$installer->run("drop table if exists {$installer->getTable("contactlab_hubcommons/deleted")};");
$logTable = $installer->getConnection()
->newTable($installer->getTable("contactlab_hubcommons/deleted"))
...
->addForeignKey($installer->getFkName('contactlab_hubcommons/deleted', 'task_id', 'contactlab_hubcommons/task', 'task_id'),
		'task_id', $installer->getTable('contactlab_hubcommons/task'), 'task_id',
		Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
