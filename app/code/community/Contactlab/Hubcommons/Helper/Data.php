 ...
 */
class Contactlab_Hubcommons_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getPlatformVersion() {
        return Mage::getStoreConfig('contactlab_hubcommons/global/platform_version');
    }
    ...
    private function _log($value, $level) {
        ...
        Mage::getModel("contactlab_hubcommons/log")
    ...
    public function isDebug() {
        return Mage::getStoreConfigFlag("contactlab_hubcommons/global/debug");
    }
