 ...
 * Task grid.
 */
class Contactlab_Hubcommons_Block_Adminhtml_Tasks_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('contactlab_hubcommons/task')
                ->getCollection()
                ->loadVisibleTasks()
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('store_id', array(
            ...
            'align' => 'left',
            'index' => 'store_id',
            'renderer' => 'contactlab_hubcommons/adminhtml_tasks_renderer_store'
        ));
        ...
        $this->addColumn('model_name', array(
            ...
            'align' => 'left',
            'index' => 'model_name',
            'renderer' => 'contactlab_hubcommons/adminhtml_tasks_renderer_model'
        ));
        $this->addColumn('status', array(
            ...
            'width' => 100,
            'type' => 'options',
            'options' => Contactlab_Hubcommons_Model_Task::$statusesNames,
            'renderer' => 'contactlab_hubcommons/adminhtml_events_renderer_status'
        ));
        $this->addColumn('actions_buttons', array(
            ...
            'index' => 'task_id',
            'width' => 135,
            'renderer' => 'contactlab_hubcommons/adminhtml_tasks_renderer_actions'
        ));
        /*$actions = array();
    ...
    private function _isAllowed($value) {
    	return Mage::helper('contactlab_hubcommons')->isAllowed('tasks', $value);
    }
    ...
    public function getRowUrl($item) {
        return $this->getUrl('*/contactlab_hubcommons_events/', array(
                    'id' => $item->getId()
        ));
    }
}
