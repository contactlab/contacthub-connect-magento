 ...
 * Rel notes block.
 */
class Contactlab_Hubcommons_Block_Adminhtml_ConfigurationCheck extends Mage_Adminhtml_Block_Widget_Container {
    /**
     * Construct
     */
    ...
    public function getSubscribersChecks() {
        if (!Mage::helper('contactlab_hubcommons')->isModuleEnabled('Contactlab_Subscribers')) {
            return array();
        }
