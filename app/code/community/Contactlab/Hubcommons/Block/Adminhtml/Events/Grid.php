 ...
 * Events grid.
 */
class Contactlab_Hubcommons_Block_Adminhtml_Events_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('contactlab_hubcommons/task_event')
            ->getCollection()
                ->addFieldToSelect('*')
                ->join('contactlab_hubcommons/task',
                    "`contactlab_hubcommons/task`.task_id = main_table.task_id",
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('send_alert', array(
            ...
            'index' => 'send_alert',
            'width' => 1,
            'renderer' => 'contactlab_hubcommons/adminhtml_events_renderer_alert'
        ));
    }
