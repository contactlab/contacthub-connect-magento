 ...
 * Status renderer.
 */
class Contactlab_Hubcommons_Block_Adminhtml_Events_Renderer_Status extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public static function renderTask(Varien_Object $row) {
        ...
        $statusDef = Contactlab_Hubcommons_Model_Task::$statuses[$status];
        if ($status === 'hidden') {
            $status = 'hidden/close';
        }
