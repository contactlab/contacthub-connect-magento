...
abstract class Contactlab_Hubcommons_Model_AbstractImportExport extends Mage_Core_Model_Abstract {
    /**
    ...
    protected function _useRemoteServer() {
        return $this->getTask()->getConfig("contactlab_hubcommons/connection/type") == 0;
    }
    ...
    protected function _useLocalServer() {
        return $this->getTask()->getConfig("contactlab_hubcommons/connection/type") == 1;
    }
