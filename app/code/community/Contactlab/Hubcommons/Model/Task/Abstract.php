 ...
 * Abstract Task.
 */
abstract class Contactlab_Hubcommons_Model_Task_Abstract extends Mage_Core_Model_Abstract
        implements Contactlab_Hubcommons_Model_Task_Interface {
	...
	protected function _checkSubscriberDataExchangeStatus() {
		$call = Mage::getModel('contactlab_hubcommons/soap_getSubscriberDataExchangeStatus');
