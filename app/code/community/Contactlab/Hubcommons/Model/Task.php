 ...
 * @method Contactlab_Hubcommons_Model_Task setStoreId($value)
 * @method Contactlab_Hubcommons_Model_Task setTaskCode($value)
 ...
 *
 * @method Contactlab_Hubcommons_Model_Task setTaskData($value)
 *
 * @method Contactlab_Hubcommons_Model_Task setDescription($value)
 * @method Contactlab_Hubcommons_Model_Task setPlannedAt($value)
 *
 * @method bool getPreventDelete()
 * @method string getStatus()
 */
class Contactlab_Hubcommons_Model_Task extends Mage_Core_Model_Abstract {
    ...
    public function _construct() {
        $this->_init("contactlab_hubcommons/task");
    }
    ...
    public static function initStaticVars() {
        foreach (self::$statuses as $key => &$value) {
            $value ['description'] = Mage::helper("contactlab_hubcommons")->__($value ['description']);
     ...
     * Add an event.
     * 
     * @return Contactlab_Hubcommons_Task_Event
     */
    public function addEvent($description = NULL, $sendAlert = 0) {
        ...
        $event = Mage::getModel("contactlab_hubcommons/task_event");
        ...
        if ($sendAlert) {
            ...
            if (!$this->getSuppressNotification()) {
                ...
                Mage::helper('contactlab_hubcommons/tasks')
    ...
    private function _useCoreAddCritical() {
        return Mage::helper("contactlab_hubcommons")->isMageSameOrNewerOf(1, 7);
    }
     ...
     * @param $model
     * @return Contactlab_Hubcommons_Model_Task
     */
    ...
    public function getEventsUrl() {
        return Mage::helper('adminhtml')->getUrl('adminhtml/contactlab_hubcommons_events/', array(
                    'id' => $this->getTaskId()
        ));
    }
     ...
     * @return Contactlab_Hubcommons_Model_Task_Interface
     */
    private function _getRunnerInstance() {
        /* @var $rv Contactlab_Hubcommons_Model_Task_Interface */
    ...
    public function isEnabled() {
        return $this->getConfigFlag("contactlab_hubcommons/global/enabled");
    }
    ...
    public function delete() {
        Mage::dispatchEvent('contactlab_hubcommons_task_delete_before', array(
            'task' => $this));
...
Contactlab_Hubcommons_Model_Task::initStaticVars();
