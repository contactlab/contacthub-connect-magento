<?php
class Contactlab_Hub_Model_Adminhtml_System_Config_Backend_Hub_Cron_Events 
extends Mage_Core_Model_Config_Data
{
    const CRON_STRING_PATH = 'crontab/jobs/contactlab_hub_export_events/schedule/cron_expr';  
