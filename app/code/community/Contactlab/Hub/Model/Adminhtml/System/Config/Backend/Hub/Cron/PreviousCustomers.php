<?php
class Contactlab_Hub_Model_Adminhtml_System_Config_Backend_Hub_Cron_PreviousCustomers 
extends Mage_Core_Model_Config_Data
{
    const CRON_STRING_PATH = 'crontab/jobs/contactlab_hub_export_previous_customers/schedule/cron_expr';  
    
    protected function _afterSave()
    {
    	$frequency = $this->getData('groups/cron_previous_customers/fields/frequency/value');
        $time = $this->getData('groups/cron_previous_customers/fields/time/value');
        $repeatMinutes = $this->getData('groups/cron_previous_customers/fields/repeat_minutes/value');
        $repeatHours = $this->getData('groups/cron_previous_customers/fields/repeat_hours/value');
